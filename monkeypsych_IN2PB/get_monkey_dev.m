...
%         
    ...
    case 'human'
        monkey_name                 = 'human';
        pathname                    = 'D:\Data\human';
        task.custom_conditions      = 'D:\monkeypsych\conditions\human\combined_condition_file_human'; % calibration
%         task.custom_conditions      = 'D:\monkeypsych\conditions\human\combined_condition_file_fixation'; % Binocular rivalry with ITI
%         task.custom_conditions      = 'D:\monkeypsych\conditions\human\combined_condition_file_fixation_continuous'; % Binocular rivalry without ITI
%         task.custom_conditions      = 'D:\monkeypsych\conditions\human\combined_condition_file_continuous_binoriv'; % continuous binocular rivalry task 
        task.vd                     = 47;
        task.screen_uh_cm           = 33.7/2;
        task.screen_width = 61-1.4;
        
    case 'Linus'
        monkey_name                 = 'Linus';
        pathname                    = 'D:\Data\Linus';
%         task.custom_conditions      = 'Y:\Projects\Binocular_rivalry\monkeypsych_IN2PB\conditions\combined_condition_file_calib'; % calibration
        task.custom_conditions      = 'Y:\Projects\Binocular_rivalry\monkeypsych_IN2PB\conditions\Linus/combined_condition_file_continuous_binoriv'; % continuous binocular rivalry task 
        task.vd                     = 42;
        task.screen_uh_cm           = 12;
        task.screen_width = 61;
