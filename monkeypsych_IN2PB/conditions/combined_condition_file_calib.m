...
%         pool_of_angles                      = [40,0,320,220,180,140]; %[20,0,340,200,180,160];
        ...
        fix_eye_y                           = 0;
        fix_hnd_y                           = 0;
        pool_of_angles                      = [45,135,225,315]; % [40,0,320,220,180,140]; %[20,0,340,200,180,160]; [40,0,320,220,180,140]
%         fix_eye_y                           = -2;
%         fix_hnd_y                           = -5;
%         pool_of_angles                      = [20,0,340,160,180,200];
        ...
        switch experiment
            ...
            case 'calibration'
                ...
                All.excentricities              = 1.5;%2.3057;
                All.angle_cases                 = [1,2,3,4];

%                 All.y_pos = [-1.7506 1.7506];
%                 All.x_pos = [-1.5006 1.5006];
...
switch Current_con.timing_con
    case 0 % 'calibration'
        ...
        task.timing.fix_time_to_acquire_eye     = 1; % from acquiring the eye to the hold state
        task.timing.tar_time_to_acquire_eye     = 1;
        task.timing.tar_inv_time_to_acquire_eye = 1;
        task.timing.fix_time_hold               = 2; % Duration the subject has to fixate
        task.timing.fix_time_hold_var           = 0;%2; %0.2
...
switch Current_con.size_con
    ...
    case 0 %'calibration'
        task.eye.fix.size       = 0.1;
        task.eye.fix.radius     = 1;
...
task.eye.fix.color_dim          = [255 0 0];%[0 0 128]; %
task.eye.fix.color_bright       = [255 0 0];%[0 0 128];
