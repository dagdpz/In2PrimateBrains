    ...
    for n_exp = 1:numel(experiments)
        ...
        switch experiment
            ...
            case 'fixation training for binoriv task'
                ...
                N_repetitions                       = 40; % repetitions of unique! combination
                ...
                pool_of_color = [32 0 0; 0 0 54]/20; % divide by 4 to make fixation spots deemer
                % pool_of_color = [32 0 0; 0 0 54]; % red;blue
                %pool_of_color = [32 0 0; 32 0 0]; %only red
                %pool_of_color = [0 0 54; 0 0 54]; %only blue
