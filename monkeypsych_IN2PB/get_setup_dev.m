...
switch SETTINGS.setup,
    ...
    case -10 % Tübingen
        ...
        SETTINGS.DefaultFigurePosition                  = [3250 800 600 600*SETTINGS.screen_h_pix/SETTINGS.screen_w_pix];
    ...
    case -1 % "DAG psychophysics BinoRiv"
        SETTINGS.whichScreen = 1;
        SETTINGS.screen_w_pix = 2560;
        SETTINGS.screen_h_pix = 1440;
        SETTINGS.screen_w_cm = 59.5;
        SETTINGS.screen_h_cm = 33.5;
        SETTINGS.ai = 0;
        SETTINGS.ao = 0;
        SETTINGS.use_digital_to_TDT = 0;
        SETTINGS.check_motion_jaw = 0;
        ...
        SETTINGS.touchscreen = 0;
        SETTINGS.interface_with_scanner = 0;
        SETTINGS.useMouse                   = 0;        % use mouse instead of eye position
        SETTINGS.useVPacq                   = 1;        % enable ViewPoint eye position acquisition
        SETTINGS.useParallel                = 0;
        
        % I/O
        SETTINGS.AI_channels                            = [0 2 4 6]; % touch_x touch_y jaw_motion body_motion
        SETTINGS.Motion_detection_interface             = 'DAQ';%'Parallel'; % e.g. MD
        SETTINGS.GUI_coordinates                        = [-1500 300 1700 1700*SETTINGS.screen_h_pix/SETTINGS.screen_w_pix]; % [left bottom width height]
        SETTINGS.ITI_GUI_coordinates                    = [-2500 650 1000 1000*SETTINGS.screen_h_pix/SETTINGS.screen_w_pix];
        SETTINGS.DefaultFigurePosition                  = [  -2596         148         560         420];
...
%         SETTINGS.GUI_coordinates                        = [ 903  -656 800 800*SETTINGS.screen_h_pix/SETTINGS.screen_w_pix];
        SETTINGS.GUI_coordinates                        = [ 900  -700 600*1.15 600]; % [left bottom width height]
